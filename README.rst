...
.. _upstream repository: https://re-git.lanl.gov/aea/stub-repositories/tardigrade-micromorphic-elasto-plasticity
...
.. code-block:: bash
   ...
   $ conda create --name tardigrade-micromorphic-elasto-plasticity-env --file environment.txt --channel file:///projects/aea_compute/aea-conda
...
2) Create the build directory and move there
   ...
   .. code-block:: bash
      ...
      $ pwd
      /path/to/tardigrade-micromorphic-elasto-plasticity/
      $ mkdir build/
      $ cd build/
...
3) Run cmake configuration
   ...
   .. code-block:: bash
      ...
      $ pwd
      /path/to/tardigrade-micromorphic-elasto-plasticity/build/
      $ cmake ..
...
5) Documentation builds to:
   ...
   .. code-block:: bash
      ...
      tardigrade-micromorphic-elasto-plasticity/build/docs/sphinx/html/index.html
