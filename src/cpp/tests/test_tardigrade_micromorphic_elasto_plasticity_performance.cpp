...
//                                         { -0.32571524, -0.95306342, -0.93025257 } };
    ...
    tardigradeConstitutiveTools::floatVector PK2_answer = { 7.20108, -0.010419, 0.40178, -0.0312379, 7.31865, -0.501715, -0.443789, 0.641519, 6.95971 };

    tardigradeConstitutiveTools::floatVector SIGMA_answer = { 7.1785, -0.0545498, -0.0987932, -0.0545498, 7.33568, 0.109286, -0.0987932, 0.109286, 6.81404 };
...
//    std::cout << "SDVS : "; for ( auto v = SDVS.begin( );         v != SDVS.end( );         v++ ){ std::cout << *v << ", "; } std::cout << "\n";
    ...
    BOOST_TEST( tolerantCheck( tardigradeVectorTools::appendVectors( dSIGMAdGradPhi ), tardigradeVectorTools::appendVectors( result_dSIGMAdGradPhi ), 1e-3, 1e-5 ) );
...
BOOST_AUTO_TEST_CASE( testEvaluateHydraModel_difficult_3, * boost::unit_test::tolerance( 1e-5 ) ){ //TODO: Maybe there is an error in the gradients w.r.t. the displacement?
    ...
    tardigradeConstitutiveTools::floatVector SDVS_answer = {  0.0106226, 0.00652946, 0.00147774, 0.00653205, 0.0111543, -0.00240772, 0.00159416, -0.00256405, -0.0210245, 0.0106306, 0.00652352, 0.00154492, 0.00652073, 0.0111647, -0.00241912, 0.00171859, -0.00270385, -0.0210408, 1.44984e-07, -8.65097e-08, -2.32573e-06, -4.4939e-08, -8.31985e-08, 2.9239e-06, 7.8105e-07, -1.11731e-07, 1.13201e-05, 7.2454e-08, 3.90015e-08, 2.80645e-06, -1.60316e-07, 1.3586e-07, -2.40339e-06, -1.95085e-07, 7.90054e-07, -5.66129e-06, 6.51471e-07, 1.59658e-07, 8.84056e-06, 3.58077e-08, 6.19628e-07, -3.91159e-06, 2.11321e-08, -5.32943e-08, 4.66545e-06, 8.21962e-28, 8.98758, -1.88323e-27, -3.20111e-29, -2.28515e-28, 4.7179e-27, 0.110357, 2.76713e-27, -2.00062e-27, 1.14598e-27 };
...
BOOST_AUTO_TEST_CASE( testEvaluateHydraModel_difficult_4, * boost::unit_test::tolerance( 5e-4 ) ){
    ...
    tardigradeConstitutiveTools::floatVector M_answer = { -0.0108873, 0.00321452, 0.436268, -0.074097, 0.0372515, -0.125495, -0.328163, 0.155894, 0.0581416, -0.0353676, -0.0641721, -0.0229707, 0.269207, 0.0515909, 0.329629, 0.0692409, -0.36987, 0.0382221, 0.0449828, 0.0566513, 1.25384, -0.0368522, 0.036337, 0.0365019, -1.20132, -0.112994, 0.0291111 };

    tardigradeConstitutiveTools::floatVector SDVS_answer = { 0.0233658, 0.0241928, -0.0188952, 0.0242305, -0.00756719, -0.00761511, -0.0191573, -0.00768843, -0.0131781, 0.0231106, 0.0240005, -0.0181469, 0.0246075, -0.00742167, -0.00784532, -0.0198988, -0.00786322, -0.0130703, 1.6484e-05, 8.16642e-06, 5.74714e-05, 2.7675e-06, 8.72768e-06, 1.88183e-05, 1.17889e-05, 6.93429e-06, 4.32918e-05, 2.01763e-06, -5.72e-06, 1.57735e-05, -7.43161e-07, -2.4417e-06, 4.37951e-06, 1.23105e-05, 6.6464e-06, 3.57688e-05, 1.05844e-05, 8.55886e-06, 4.49823e-05, 1.16168e-05, -1.25522e-06, 3.46437e-05, -1.56452e-05, -5.70411e-06, -6.11592e-05, 3.02798e-24, 4.97209, 1.25612e-24, -1.28484e-24, -9.65991e-24, 1.1623e-23, 0.0960879, -7.13559e-24, -1.74752e-23, -2.99849e-24 };
...
{ {  0.021098, -0.001426,  0.003623 },
  ...
  { -0.002557,  0.004294, -0.044437 } };
    ...
    tardigradeConstitutiveTools::floatVector SDVS_answer = { -0.00540907, 0.0201288, 0.00644233, 0.0201198, -0.00676143, -0.00849111, 0.00690441, -0.00908192, 0.0157183, -0.00540473, 0.0202057, 0.00563266, 0.0202134, -0.00695702, -0.00741807, 0.00634141, -0.00837407, 0.0158932, 3.54253e-06, 1.37056e-06, -6.61657e-06, -1.12583e-06, 8.89558e-08, 6.56662e-06, 5.86212e-06, -1.08602e-06, -2.05309e-05, -5.75537e-07, 5.87735e-07, 6.47761e-06, -2.62242e-06, -2.63729e-06, -7.29034e-06, -1.04981e-06, 4.21174e-06, 2.41893e-05, 5.82389e-06, -2.89086e-07, -2.83413e-05, -4.85834e-07, 4.38003e-06, 3.15114e-05, -8.90182e-07, 1.24124e-06, 1.37233e-05, 5.15022e-24, 116.919, 4.49973e-23, 3.5662e-22, 0, 0, 0.19808, 1.18479e-21, 0, 1.68029e-21 };
