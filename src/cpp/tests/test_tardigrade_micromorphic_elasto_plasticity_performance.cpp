...
//}
//
//BOOST_AUTO_TEST_CASE( testEvaluateHydraModel_difficult_12, * boost::unit_test::tolerance( 5e-4 ) ){
//    /*!
//     * Test the evaluation of the constitutive model.
//     *
//     */
...
//    double s = 1.00;//0.96875;
//
//    std::vector< double > _time = { 1.000000e-01, 1.000000e-01 };
//
//    std::vector< double > time = { _time[ 0 ] - _time[ 1 ] * ( 1 - s ), s * _time[ 1 ] };
//
//    //Initialize the material parameters
//    std::vector< double > fparams = {  2.000000e+00, 1.000000e+03, 1.000000e+02, 2.000000e+00, 7.000000e+02, 1.000000e+04, 2.000000e+00, 1.000000e+03, 1.000000e+04, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 2.948000e+04, 2.548000e+04, 5.000000e+00, 1.000000e+03, 4.000000e+02, -1.500000e+03, -1.400000e+03, -3.000000e+03, 1.100000e+01, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 1.000000e+06, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 4.000000e+02, -3.000000e+03, 5.000000e-01, 5.000000e-01, 5.000000e-01, 1.000000e-09, 1.000000e-09 };
//
//    //Initialize the gradient of the macro displacement
//    double _current_grad_u[ 3 ][ 3 ] = { {  -3.222726e-01, -7.691696e-01, 5.578526e-02 },
//                                         {  -5.380195e-01, -6.401393e-01, 2.223529e-02 },
//                                         {   6.430908e-02,  3.440272e-01, 2.402674e-01 } };
//
//    double previous_grad_u[ 3 ][ 3 ] = { { 0.000000e+00, 0.000000e+00, 0.000000e+00 },
...
//
//    //Initialize the micro displacement
//    double _current_phi[ 9 ] = { -1.322877e-02, 5.032085e-02, 7.516229e-03, -4.076373e-02, -3.195901e-02, -4.275940e-02, -1.623799e-02, 1.136056e-01, 4.065325e-02 };
//
//    double previous_phi[ 9 ] = { 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00 };
//
//    double current_phi[ 9 ];
//    for ( unsigned int i = 0; i < 9; i++ ){
//        current_phi[ i ] = ( 1 - s ) * previous_phi[ i ] + s * _current_phi[ i ];
...
//
//    //Initialize the gradient of the micro displacement
//    double _current_grad_phi[ 9 ][ 3 ] = { {  1.145413e-05, -1.568357e-05,  3.731843e-07 },
//                                           {  1.205675e-05, -3.661569e-05,  3.798540e-06 },
//                                           { -4.984364e-06,  7.393326e-07,  1.788514e-06 },
//                                           {  1.043610e-05, -2.921907e-05,  3.882871e-06 },
//                                           { -7.333749e-06,  1.819250e-05,  2.893592e-06 },
//                                           { -1.173375e-06,  8.459098e-06,  2.886155e-05 },
//                                           { -3.823043e-06,  8.968461e-07,  8.871146e-07 },
//                                           { -8.267361e-07,  5.712924e-06,  2.574801e-05 },
//                                           { -8.569541e-06, -1.222000e-05, -2.320925e-06 } };
//
//    double previous_grad_phi[ 9 ][ 3 ] = { {  0.000000e+00, 0.000000e+00, 0.000000e+00 },
//                                           {  0.000000e+00, 0.000000e+00, 0.000000e+00 },
//                                           {  0.000000e+00, 0.000000e+00, 0.000000e+00 },
//                                           {  0.000000e+00, 0.000000e+00, 0.000000e+00 },
//                                           {  0.000000e+00, 0.000000e+00, 0.000000e+00 },
...
//
//    //Initialize the state variable vector
//    std::vector< double > SDVSDefault = { 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00 };
//
//    //Initialize the additional degree of freedom vectors
//    std::vector< double > current_ADD_DOF;
//    std::vector< std::vector< double > > current_ADD_grad_DOF;
...
//
//}
//BOOST_AUTO_TEST_CASE( testEvaluateHydraModel_difficult_13, * boost::unit_test::tolerance( 5e-4 ) ){
//    /*!
//     * Test the evaluation of the constitutive model.
//     *
//     */
...
//
//    //Initialize the gradient of the macro displacement
//    double _current_grad_u[ 3 ][ 3 ] = { {  1.183726e-01,  1.530554e-01, -2.654745e-02 },
//                                         {  9.384177e-01, -8.426481e-01, -2.914552e-01 },
//                                         { -1.166684e-01, -5.028414e-01,  1.930133e-02 } };
//
//    double previous_grad_u[ 3 ][ 3 ] = { { 0.000000e+00, 0.000000e+00, 0.000000e+00 },
//                                         { 0.000000e+00, 0.000000e+00, 0.000000e+00 },
//                                         { 0.000000e+00, 0.000000e+00, 0.000000e+00 } };
...
//
//    //Initialize the micro displacement
//    double _current_phi[ 9 ] = { -3.668461e-03, 8.119152e-03, 1.339143e-01, -5.029333e-03, -1.774171e-03, -7.176994e-02, -6.401379e-02, 2.785918e-04, 4.674351e-03 };
//
//    double previous_phi[ 9 ] = { 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00 };
//
//    double current_phi[ 9 ];
...
//
//    //Initialize the gradient of the micro displacement
//    double _current_grad_phi[ 9 ][ 3 ] = { { -2.514599e-06,  2.811291e-05,  4.265211e-05 },
//                                           { -2.201496e-05,  3.831629e-05, -9.919755e-07 },
//                                           {  1.413051e-05, -1.467600e-05, -6.367683e-06 },
//                                           { -1.858010e-05,  2.926642e-05,  4.384108e-06 },
//                                           {  4.946746e-06, -1.487576e-05, -5.391601e-05 },
//                                           {  7.548857e-06, -8.999873e-06, -6.157401e-06 },
//                                           {  1.441073e-05, -8.939309e-06, -3.472918e-06 },
//                                           {  7.141107e-06, -4.270310e-06, -1.602203e-06 },
//                                           {  7.784336e-06, -2.115114e-05,  6.017219e-06 } };
//
//    double previous_grad_phi[ 9 ][ 3 ] = { {  0.000000e+00, 0.000000e+00, 0.000000e+00 },
//                                           {  0.000000e+00, 0.000000e+00, 0.000000e+00 },
//                                           {  0.000000e+00, 0.000000e+00, 0.000000e+00 },
...
BOOST_AUTO_TEST_CASE( testEvaluateHydraModel_difficult_14, * boost::unit_test::tolerance( 5e-4 ) ){
    /*!
     * Test the evaluation of the constitutive model.
     *
     */
    ...
    //Initialize the material parameters
    std::vector< double > fparams = { 2.000000e+00, 5.000000e+00, 1.000000e-03, 2.000000e+00, 7.000000e+00, -4.281e1, 2.000000e+00, 1.000000e+10, 1.000000e+04, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 7.196758e+03, 2.140519e+03, 5.000000e+00, 1.480974e+04, 2.477969e+03, 3.058409e+03, 2.448930e+03, 1.529939e+03, 1.100000e+01, 2.686080e+02, 4.476799e+02, 4.476799e+02, 4.936579e+02, 2.419892e+02, 6.194922e+02, 6.149862e+02, 4.543555e+02, 4.543555e+02, 3.744991e+02, 4.543555e+02, 2.000000e+00, 2.477969e+03, 1.529939e+03, 5.000000e-01, 5.000000e-01, 5.000000e-01, 1.000000e-09, 1.000000e-09 };
//    std::vector< double > fparams = { 2.000000e+00, 5.000000e+00, 1.000000e-03, 2.000000e+00, 7.000000e+00, -4.281000e+01, 2.000000e+00, 1.000000e+10, 1.000000e+04, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 7.196758e+03, 2.140519e+03, 5.000000e+00, 1.480974e+04, 2.477969e+03, 3.058409e+03, 2.448930e+03, 1.529939e+03, 1.100000e+01, 2.686080e+02, 4.476799e+02, 4.476799e+02, 4.936579e+02, 2.419892e+02, 6.194922e+02, 6.149862e+02, 4.543555e+02, 4.543555e+02, 3.744991e+02, 4.543555e+02, 2.000000e+00, 2.477969e+03, 1.529939e+03, 5.000000e-01, 5.000000e-01, 5.000000e-01, 1.000000e-09, 1.000000e-09 };

    //Initialize the gradient of the macro displacement
    double _current_grad_u[ 3 ][ 3 ] = { { 1.001599e-04, -3.500506e-04, 1.824082e-04 },
                                         { 1.487131e-03,  2.195505e-04, 3.725358e-04 },
                                         { 2.148122e-05, -1.903619e-06, 1.255855e-04 } };
    ...
    //Initialize the micro displacement
    double _current_phi[ 9 ] = { -1.050182e-03, -2.545138e-03, -2.271382e-04, -7.502338e-04, 1.143536e-03, -7.133356e-05, -2.294005e-04, -2.319992e-04, -3.745679e-04 };
    ...
    //Initialize the gradient of the micro displacement
    double _current_grad_phi[ 9 ][ 3 ] = { { -3.509916e-05,  6.141381e-04, -3.045633e-05 },
                                           { -1.222043e-03,  9.692540e-05,  6.563429e-05 },
                                           { -1.981314e-05,  1.123093e-05, -6.670254e-05 },
                                           { -3.526799e-04, -3.884797e-04,  3.578556e-05 },
                                           {  4.372456e-04,  2.611216e-04,  1.613563e-04 },
                                           {  1.479997e-05, -4.977390e-05, -2.999297e-05 },
                                           {  1.144487e-05, -2.773518e-05,  1.187110e-04 },
                                           {  3.423609e-06,  1.896366e-05,  2.873201e-04 },
                                           { -4.094819e-04, -3.126091e-05, -4.542264e-06 } };
